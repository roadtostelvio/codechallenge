...
export interface CdsServiceClient {
    ...
    associate(entityName: string, entityId: string, relationship: string, relatedEntities: Promise<EntityReference[]>): Promise<void>;
    disassociate(entityName: string, entityId: string, relationship: string, relatedEntities: EntityReference[]): Promise<void>;
